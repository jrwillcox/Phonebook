    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            using (ChannelFactory<IPhonebookService> cf = new ChannelFactory<IPhonebookService>(new WebHttpBinding(), "http://localhost:8000"))
            {
                ...
                //request = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><ServiceRequest xmlns=\"http://www.phonebook.com/ServiceRequest\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\"><Header><MessageID>1</MessageID><MessageType>ListEntries</MessageType></Header><Payload><ListEntries><surname>こんにちは</surname></ListEntries></Payload></ServiceRequest>";                
                // Create Entry
                //request = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><ServiceRequest xmlns=\"http://www.phonebook.com/ServiceRequest\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\"><Header><MessageID>1</MessageID><MessageType>CreateEntry</MessageType></Header><Payload><CreateEntry><surname>Willcox</surname><firstname>John</firstname><phone>+44 207 184 8309</phone><address>23 Winslade Road</address></CreateEntry></Payload></ServiceRequest>";
                // Update Entry
                //request = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><ServiceRequest xmlns=\"http://www.phonebook.com/ServiceRequest\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\"><Header><MessageID>1</MessageID><MessageType>UpdateEntry</MessageType></Header><Payload><UpdateEntry><id>ABD191A9-5297-4F19-A2C7-C7FA856796DF</id><surname>こんにちは</surname><firstname>John</firstname><phone>+44 207 184 8506</phone><address>23 Winslade Road</address></UpdateEntry></Payload></ServiceRequest>";
				// Remove Entry
				//request = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><ServiceRequest xmlns=\"http://www.phonebook.com/ServiceRequest\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\"><Header><MessageID>1</MessageID><MessageType>RemoveEntry</MessageType></Header><Payload><RemoveEntry><id>7A9CF73C-0238-4D37-A66F-ECDEB0B7FA98</id></RemoveEntry></Payload></ServiceRequest>";
